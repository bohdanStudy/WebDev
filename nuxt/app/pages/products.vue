        ...
        <tr>
          <th class="p-4 font-semibold text-left border-r border-gray-200">
            <div class="flex items-center gap-1 cursor-pointer select-none" @click="toggleSort('title')">
              <span>Назва</span>
              <span class="text-gray-400">{{ sortIcon('title') }}</span>
            </div>
          </th>
